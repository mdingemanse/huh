...
list.of.packages <- c("tidyverse","ggthemes","GGally","directlabels","ggmosaic")
...
# draw front/height plots with some jitter and alpha
...
ggplot(v.langs, aes(height, front, label=languages)) +
  ...
  geom_dl(method=list("smart.grid",fontface="bold"))
